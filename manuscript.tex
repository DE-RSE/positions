...
\author[22]{Peter Ebert}
\author[23]{Bernd Flemisch}
\author[24]{Sven Friedl}
\author[25]{Bernadette Fritzsch}
\author[26]{Maximilian D.\ Funk}
\author[3]{Volker Gast}
\author[27]{Florian Goth}
\author[28]{Jean-No\"{e}l Grad}
\author[29]{Sibylle Hermann}
\author[30]{Florian Hohmann}
\author[31]{Stephan Janosch}
\author[32]{Dominik Kutra}
\author[33]{Jan Linxweiler}
\author[10,34]{Thilo Muth}
\author[35]{Wolfgang Peters-Kottig}
\author[36]{Fabian Rack}
\author[37]{Fabian H.C.\ Raters}
\author[38]{Stephan Rave}
\author[39]{Guido Reina}
\author[40]{Malte Reißig}
\author[41,42]{Timo Ropinski}
\author[43]{Joerg Schaarschmidt}
\author[44,45,46]{Heidi Seibold}
\author[47]{Jan P.\ Thiele}
\author[48]{Benjamin Uekerman}
\author[49]{Stefan Unger}
\author[28]{Rudolf Weeber}
\author[50]{Piotr Wojciech Dabrowski}
...
\affil[22]{Center for Bioinformatics Saar, Saarland Informatics Campus, Germany}
\affil[23]{Institute for Modelling Hydraulic and Environmental Systems, University of Stuttgart, Germany}
\affil[24]{Berlin Institute of Health, Germany}
\affil[25]{Scientific Computing, Alfred Wegener Institute, Helmholtz Center for Polar and Marine Research Bremerhaven, Germany}
\affil[26]{Max-Planck-Gesellschaft e.V.}
\affil[27]{Institut für Theoretische Physik und Astrophysik, Universität Würzburg, Germany}
\affil[28]{Institut für Computerphysik, University of Stuttgart, Germany}
\affil[29]{University Library, University of Stuttgart, Germany}
\affil[30]{Zentrum für Medien-, Kommunikations- und Informationsforschung (ZeMKI), Universität Bremen, Germany}
\affil[31]{Max Planck Institue of Molecular Cell Biology and Genetics, Dresden, Germany}
\affil[32]{European Molecular Biology Laboratory, Heidelberg, Germany}
\affil[33]{Center for Mechanics, Uncertainty and Simulation in Engineering, Technische Universität Braunschweig, Germany}
\affil[34]{eScience Division, Federal Institute for Materials Research and Testing, Berlin, Germany}
\affil[35]{Konrad-Zuse-Zentrum für Informationstechnik Berlin (ZIB), Germany}
\affil[36]{FIZ Karlsruhe - Leibniz Institute for Information Infrastructure, Germany}
\affil[37]{Department of Economics, University of Goettingen, Germany}
\affil[38]{Applied Mathematics, University of Münster, Germany}
\affil[39]{Visualization Research Center, University of Stuttgart, Germany}
\affil[40]{Institute for Advanced Sustainability Studies e.V.}
\affil[41]{Institute of Media Informatics, Ulm University, Germany}
\affil[42]{Department of Science and Technology, Linköping University, Sweden}
\affil[43]{Institute of Nanotechnology, Karlsruhe Institute of Technology (KIT),  Germany}
\affil[44]{LMU Munich, Germany}
\affil[45]{Bielefeld University, Germany}
\affil[46]{Helmholtz Zentrum Munich, Germany}
\affil[47]{Institute of Applied Mathematics, Leibniz University Hannover, Germany}
\affil[48]{Energy Technology, Eindhoven University of Technology, The Netherlands}
\affil[49]{Julius Kühn-Institut (JKI), Federal Research Centre for Cultivated Plants, Quedlinburg, Germany}
\affil[50]{School of Computing, Communication and Business, Hochschule für Technik und Wirtschaft Berlin, Germany}
